...
import { role, examsData, assignmentsData, resultsData, eventsData } from "@/lib/data";
...
const EventListPage = () => {
    const renderRow = (item: Result) => (
        ...
        text-sm hover:bg-lamaPurpleLight">
            ...
            <td>
            <p className="hidden md:table-cell">{item.startTime}</p>
            </td>   
            <td>
            <p className="hidden md:table-cell">{item.endTime}</p>
            </td> 
